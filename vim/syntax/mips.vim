...
syntax match mipsLabel /\w\(\w\| \)\+\w:/ contains=mipsLabelColon

" Registers
syntax match mipsRegister "\$zero"
syntax match mipsRegister "\$[0-9]+"
syntax match mipsRegister "\$v[01]"
syntax match mipsRegister "\$a[0-3]"
syntax match mipsRegister "\$t[0-9]"
syntax match mipsRegister "\$s[0-7]"
syntax match mipsRegister "\$k[01]"
...
" Directives
syntax match mipsDirective "\.[246]byte"
